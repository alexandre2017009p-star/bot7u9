var Autobot = {
    title: 'Autobot',
    version: 'v0.55',
    domain: window.location.protocol + "//cdn.jsdelivr.net/gh/alexandre2017009p-star/bot7u9@5.99/",
    botWnd: '',
    isLogged: false,
    Account: {
    ...
    initWnd: function () {
        ...
        Autobot.botWnd = Layout.dialogWindow.open('', botnasa.title + ' v">' + Autobot.version + '</span>', 500, 350, '', false);
